...
update diabetes_patients_with_hospitals set  diagnosed_patients_Private = "0"  where  diagnosed_patients_Private = "N/A";
...
select * from funds_realsed_by_goverment;
 ...
 ALTER TABLE  funds_realsed_by_goverment RENAME COLUMN `s_No` TO S_No;
...
update gov_cells set  State_cells = "0"  where  State_cells = "NA";
 ...
 alter table gov_cells  modify  State_cells varchar(255);
          ...
          # top states which have most number of diagnosed_patients and patients_with_symptoms
select * from diabetes_patients_with_hospitals; 
...
group by state order by patients_with_symptoms desc;
   ...
   /*                  patients_with_symptoms         diagnosed_patients
 Uttar Pradesh	              490981	                    23448
Maharashtra	                  222145	                    13792
Madhya Pradesh	              171407	                    10037        */
...
/*                      gov_hospitals_patients    private_hospitals_patients
Uttar Pradesh	                 21480	                1968
Tamil Nadu	                     20196	                3655
West Bengal	                     12541	                 910   */ 
...
/*                     District_Cell                  patients
Tamil Nadu	                 32	                         23851
Uttar Pradesh	             38	                         23448
Maharashtra                  17	                         13792                */ 
